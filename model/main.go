...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&UserSubscriptionModelUsage{}, "UserSubscriptionModelUsage"},
...
` + "`user_visible`" + ` numeric NOT NULL DEFAULT 1,
...
PRIMARY KEY (` + "`id`" + `)
	...
	required := []sqliteColumnDef{
		...
		{Name: "user_visible", DDL: "`user_visible` numeric NOT NULL DEFAULT 1"},
		...
		{Name: "model_amount_limits", DDL: "`model_amount_limits` text"},

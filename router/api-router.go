...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionAdminRoute.GET("/plans/:id/user_subscriptions", controller.AdminListPlanUserSubscriptions)
		...
		billingRoute.GET("/subscription", middleware.AdminAuth(), controller.GetSubscriptionAnalysis)
		...
		systemLogRoute.Use(middleware.AdminAuth())
		{
			systemLogRoute.GET("/files", controller.GetSystemLogFiles)
			systemLogRoute.GET("/content", controller.GetSystemLogContent)
		}
